...
export default function Cards() {
  ...
  },
  {
    ...
    // 👉 you can paste the rest of your JSON here...
  ];
    ...
    <div className="flex flex-wrap gap-4 p-4 justify-center">
      {products.map((product) => (
        <div key={product.id} className="max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
          <a href="#">
            <img className="rounded-t-lg w-full h-64 object-contain" src={product.image} alt={product.title} />
          </a>
          <div className="p-5">
            <a href="#">
            ...
            <p className="mb-3 font-semibold text-gray-900 dark:text-gray-300">
              ${product.price}
            </p>
