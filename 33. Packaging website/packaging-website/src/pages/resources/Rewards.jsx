          ...
          <div data-aos="fade-down" data-aos-delay="200">
            ...
            <div className="relative w-full h-72 sm:h-88 md:h-105 rounded-2xl overflow-hidden mb-4 sm:mb-6">
              ...
              <div className="absolute inset-0 z-10 p-4 sm:p-6 md:p-8 flex flex-col justify-between">
                <div>
                  <p
                    className={`text-xs sm:text-sm transition-colors duration-300 ${isDark ? "text-white" : "text-black"
                      }`}
                  >
                    With Yucca
                  </p>
                  ...
                  <h2
                    className={`text-2xl sm:text-3xl md:text-4xl font-medium transition-colors duration-300 ${isDark ? "text-white" : "text-black"
                      }`}
                  >
      ...
      <section className="bg-[#f7f4e9] px-6 sm:px-10 md:px-20 lg:px-40 py-12 sm:py-16 md:py-24">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20">
          ...
          <div data-aos="fade-right">
            ...
            <Link to="/faqs">
              <button className="mt-6 cursor-pointer sm:mt-8 bg-black text-white text-sm px-6 py-3 rounded w-full sm:w-auto hover:bg-black/90 transition">
                View all
              </button>
            </Link>
          </div>
