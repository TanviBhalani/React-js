...
export default function Cart() {
  ...
  return (
    ...
    //     <div>
    //       <div className="bg-[#e1dfcf] p-4 mb-6 text-sm flex gap-2">
    //         <b>Yucca Rewards</b>
    //         <span>
    //           You qualify to earn <b>R1.00</b> cash back.
    ...
    //       <button
    //         onClick={clearCart}
    //         className="w-full bg-black text-white py-5 mt-6 text-lg"
    //       >
    //         Checkout
    //       </button>
    //     </div>
...
//       <button className="border px-6 py-3 text-sm text-gray-400 cursor-not-allowed w-full md:w-auto">
//         Update cart
//       </button>
//     </div>
...
//         <span>
//           You qualify to earn <b>R1.00</b> cash back on this order.
//           <span className="underline ml-1 cursor-pointer">Login</span>{" "}
//           or{" "}
...
//       <button className="w-full bg-black text-white py-4 md:py-5 mt-6 text-lg">
//         Checkout
//       </button>
//     </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-[1.4fr_1fr] gap-10 md:gap-16">
      ...
      {cart.map((item, index) => (
        ...
        >
          ...
          <div className="flex flex-col items-end gap-3">
            ...
            <div className="flex items-center border px-5 py-2 gap-4">
              <button
                className="cursor-pointer px-1 hover:opacity-60 active:scale-95"
                onClick={() => console.log("decrease qty")}
              >
                −
              </button>
    ...
    <div>
      ...
      <div className="bg-[#e1dfcf] p-4 mb-6 text-sm flex gap-3 items-start">
        ...
        <span>
          You qualify to earn <b>R1.00</b> cash back on this order.
          <span className="underline ml-1 cursor-pointer hover:opacity-70">
            Login
          </span>{" "}
          or{" "}
