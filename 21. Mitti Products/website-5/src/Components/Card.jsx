...
//     return (
//         <>
//             <div className="w-80 h-125 mt-10">
...
//                     <button onClick={()=> addToCart(id)} className='bg-[#706745] text-[1.0rem] px-27 py-2 text-[#f5f3eb] mt-3 cursor-pointer hover:bg-[#60542a]'>Add to Cart</button>
//                 </div>
//             </div>
